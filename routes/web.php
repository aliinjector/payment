...
Route::get('/user-cart/{shop}/{userID}', 'CartController@show')->middleware('auth')->name('cart.show');
Route::put('/user-cart/{shop}/{userID}/quantity-change/{id}', 'CartController@quantity')->middleware('auth')->name('quantity');
