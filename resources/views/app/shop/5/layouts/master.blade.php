...
<head>
    ...
    <title>قالب شماره 4</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="/app/shop/5/assets/images/favicon.ico">

    <!-- CSS
    ========================= -->

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="/app/shop/5/assets/css/bootstrap.min.css">

    <!-- Icon Font CSS -->
    <link rel="stylesheet" href="/app/shop/5/assets/css/simple-line-icons.css">
    <link rel="stylesheet" href="/app/shop/5/assets/css/ionicons.min.css">

    <!-- Plugins CSS -->
    <link rel="stylesheet" href="/app/shop/5/assets/css/plugins.css">

    <!-- Main Style CSS -->
    <link rel="stylesheet" href="/app/shop/5/assets/css/style.css">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                       ...
                       <div class="language-currency-wrapper">
                           <ul>
                                <li class="drodown-show"><a href="#">ورود</a>

                                </li>
                                <li class="drodown-show"><a href="#"> عضویت </a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-5 col-5">
                        <div class="logo">
                            <a href="index.html"><img src="assets/images/logo/omid.png" alt=""></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="footer-info mt--60">
                            ...
                            <ul class="footer-info-list">
                                <li>
                                    <i class="ion-ios-location-outline"></i> آدرس
                                </li>
                                <li>
                                    <i class="ion-ios-email-outline"></i> ایمیل : <a href="#">yourmail@gmail.com</a>
                                </li>
                                <li>
                                    <i class="ion-ios-telephone-outline"></i> شماره تماس
                                </li>
                            </ul>
                                        ...
                                        <div class="product_big_images-top">
                                            <div class="portfolio-full-image tab-content">
                                                <div role="tabpanel" class="tab-pane active" id="img-tab-5">
                                                    <img src="assets/images/product-details/big-img/w1.jpg" alt="full-image">
                                                </div>
                                                <div role="tabpanel" class="tab-pane product-video-position" id="img-tab-6">
                                                    <img src="assets/images/product-details/big-img/w2.jpg" alt="full-image">
                                                </div>
                                                <div role="tabpanel" class="tab-pane product-video-position" id="img-tab-7">
                                                    <img src="assets/images/product-details/big-img/w3.jpg" alt="full-image">
                                                </div>
                                                <div role="tabpanel" class="tab-pane product-video-position" id="img-tab-8">
                                                    <img src="assets/images/product-details/big-img/w4.jpg" alt="full-image">
                                                </div>
                                        ...
                                        <ul class="product_small_images-bottom horizantal-product-active nav" role="tablist">
                                            ...
                                            <li role="presentation" class="pot-small-img">
                                                <a href="#img-tab-8" role="tab" data-toggle="tab">
                                                    <img src="assets/images/product-details/small-img/4.jpg" alt="small-image">
                                                </a>
                                            </li>
                                            <li role="presentation" class="pot-small-img">
...
<!-- jQuery JS -->
<script src="/app/shop/5/assets/js/vendor/jquery-1.12.0.min.js"></script>
<!-- Popper JS -->
<script src="/app/shop/5/assets/js/popper.min.js"></script>
<!-- Bootstrap JS -->
<script src="/app/shop/5/assets/js/bootstrap.min.js"></script>
<!-- Plugins JS -->
<script src="/app/shop/5/assets/js/plugins.js"></script>
<!-- Ajax Mail -->
<script src="/app/shop/5/assets/js/ajax-mail.js"></script>
<!-- Main JS -->
<script src="/app/shop/5/assets/js/main.js"></script>
