<div class="tt-product thumbprod-center">
    <div style="height: 400px;display:flex;" class="tt-image-box">
        ...
        <a style="margin: auto;" href="{{ route('product', ['shop'=>$shop->english_name, 'id'=>$product->id]) }}"><span class="tt-img"><img src="/app/shop/2/images/loader.svg" data-src="/{{ $product->galleries->first()->filename }}" alt=""></span><span class="tt-img-roll-over"><img src="/app/shop/2/images/loader.svg" data-src="/{{ $product->galleries[1]->filename }}" alt=""></span></a>
    </div>
