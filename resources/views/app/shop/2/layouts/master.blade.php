                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-7 col-lg-6">
                                <div class="tt-product-single-info">
                                    ...
                                    <div class="tt-review">
                                        <div class="tt-rating"><i class="icon-star"></i> <i class="icon-star"></i> <i class="icon-star"></i> <i class="icon-star-half"></i> <i class="icon-star-empty"></i></div><a href="#">(1 Customer Review)</a>
                                    </div>
