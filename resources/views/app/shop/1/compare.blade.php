                ...
                <ul class="cd-products-columns">
                    ...
                    <li class="product" style="list-style: none;">
                        <div class="top-info">
                            ...
                            <a href="{{ route('product', ['shop'=>$shop->english_name, 'slug'=>$compareProduct->slug, 'id' => $compareProduct->id]) }}"><img src="{{ asset($compareProduct->image['250,250'] ? $compareProduct->image['250,250'] : '/images/no-image.png') }}" alt="product image" class="w-100 compare-img" style="max-height:15vh;max-width: 150px;">
                            </a>
                            <h3>
