                            ...
                            <div class="row align-items-center justify-content-center">
                                ...
                                <div class="col-lg-7 col-sm-10 text-center text-lg-left">
                                    <div class="banner-caption cpn tc-light">
                                        <div class="cpn-head">
                                            <h1 class="title animated" data-animate="fadeInUp" data-delay="1">شرکت
                                                فناورستاره نوران <br class="d-none d-md-block"> ارایه دهنده راهکار های
                                                نوین فین تکی</h1>
                                        </div>
                                        <div class="cpn-text">
                                            ...
                                            <ul class="list list-check animated" data-animate="fadeInUp"
                                                data-delay=".4">
                                                <li> تجربه لذتبخش پرداخت</li>
                                                <li> تنوع در بستر های پرداختی</li>
                                                <li>امکان مدیریت مالی و پرداختی</li>
                                                <li>پتیبانی آنلاین</li>
                                            </ul>
                                        </div>
                                        <div class="cpn-action">
                                            <div class="cpn-btns animated" data-animate="fadeInUp" data-delay="1.2">
                                                <a class="btn btn-grad" href="{{ route('register') }}">عضویت در سیستم
                                                    پایان پی</a>
                                            </div>
    ...
    <main class="nk-pages">
        ...
        <section id="about" class="section bg-light section-l section-about" id="about">
            ...
            <div class="container">
                    ...
                    <div class="row align-items-center gutter-vr-30px pdb-l">
                        <div class="col-lg-6">
                            <div class="nk-block-text">
                                <h2 class="title animated" data-animate="fadeInUp" data-delay=".1">درباره فناور ستاره
                                    نوران</h2>
                                <p class="animated" data-animate="fadeInUp" data-delay=".2">
                                    شرکت فناورستاره نوران با خط مشی حرکت بر لبه فناوری در راستای ارائه سیستم پرداخت
                ...
                <div class="section-head">
                    <h2 class="title title-lg animated" data-animate="fadeInUp" data-delay=".6">مزایای سامانه پایان
                        پی</h2>
                </div><!-- .section-head @e -->
                <!-- Block @s -->
                        ...
                        <div class="col-lg-4">
                            <div class="feature animated" data-animate="fadeInUp" data-delay=".7">
                                ...
                                <div class="feature-text">
                                    ...
                                    <p> تنها با داشتن اینترنت، میتوان از خدمات سامانه بهره مند شد و این موضوع منجر به
                        ...
                        <div class="col-lg-4">
                            <div class="feature animated" data-animate="fadeInUp" data-delay=".8">
                                ...
                                <div class="feature-text">
                                    ...
                                    <p> در سامانه پایان پی قابلیت گزارش گیری در قالب نمودار های متنوع، جداول شخصی سازی
                        ...
                        <div class="col-lg-4">
                            <div class="feature animated" data-animate="fadeInUp" data-delay=".9">
                                ...
                                <div class="feature-text">
                                    ...
                                    <p> باتوجه به مالتی پلتفرم بودن سامانه پایان پی، قابلیت بهره مندی از تمامی قابلیت
                                        های سامانه از تمام پلتفرم ها فراهم میباشد. </p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section id="services" class="section section-l section-problem bg-light" id="problem">
            ...
            <div class="container">
                ...
                <div class="section-head text-center wide-auto-sm">
                    <h2 class="title animated" data-animate="fadeInUp" data-delay=".1">راهکار های کلیدی سامانه پایان
                        پی</h2>
                    <p class="animated" data-animate="fadeInUp" data-delay=".2">در این قسمت لیست خدمات اصلی سامانه پایان
                        پی را مشاهده مینمایید</p>
                </div><!-- .section-head @e -->
                <!-- Block @s -->
        ...
        <section class="section section-l section-solution bg-light pt-0" id="solution">
            ...
            <div class="container">
                ...
                <div class="section-head text-center wide-auto-sm">
                    ...
                    <p class="animated" data-animate="fadeInUp" data-delay=".2">در این قسمت سایر خدمات سامانه پایان پی
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <div class="nk-block-text">
                                            ...
                                            <p> تیم برنامه نویسی پایان پی، با درنظر گرفتن نیاز تمامی کاربران محترم
                                                سامانه اقدام به ایجاد فایل های ویدیویی آموزشی مربوط به تمامی قسمت های
                                                سامانه و پلاگین ها برای انواع سیستم های محتوی و فریم ورک های وب کرده و
                                                شما کاربران گرامی میتوانید با ورود به بخش مستندات از این فایل ها استفاده
                                                نمایید. </p>
                ...
                <div class="nk-block nk-block-text-wrap">
                    <div class="row align-items-center justify-content-center flex-row-reverse">
                        ...
                        <div class="col-lg-5 col-md-10 text-center text-lg-left">
                            <div class="nk-block-text">
                                <h2 class="title animated" data-animate="fadeInUp" data-delay=".1">نرم افزار موبایل <br
                                        class="d-none d-md-block"> پایان پی</h2>
                                <p class="animated" data-animate="fadeInUp" data-delay=".2"> باتوجه به افزایش روز افزودن
                                    استفاده از تلفن همراه بعنوان دریچه ارتباط با دنیای مجازی، تیم طراحی و توسعه شرکت
                                    فناور ستاره نوران با هدف ایجاد پلتفرم یکپارچه و سهولت در استفاده از سامانه پایان پی،
                                    اقدام به طراحی اپلیکیشن موبایل کرده است که به زودی قابل دسترس عموم قرار خواهد
                                    گرفت. </p>
        ...
        <section class="section section-l section-wallet-bottom bg-white pdt-0" id="wallet">
            ...
            <div class="container">
                ...
                <div class="nk-block nk-block-text-grp mgb-m30">
                    <h6 class="title title-xs tc-primary pdb-s animated" data-animate="fadeInUp" data-delay=".4">
                        شاخص های پایان پی</h6>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="feature feature-s5 animated" data-animate="fadeInUp" data-delay=".5">
                                <h4 class="title title-md">تضمین بازگشت وجه</h4>
                                <p> تضمین بازگشت وجه به خریدار، یکی از راه های موثر جهت کاهش نگرانی پرداخت است
                                    که پایان پی با ارایه ضمانت پرداخت، اطمینان لازم را به خریداران میدهد.</p>
                            </div>
                        </div>
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-5">
                            <div class="nk-block-text">
                                <h6 class="title title-xs tc-primary animated" data-animate="fadeInUp"
                                    data-delay=".1"></h6>
                                <h2 class="title animated" data-animate="fadeInUp" data-delay=".2"> مزایای پایان پی</h2>
                                <p class="animated" data-animate="fadeInUp" data-delay=".3">سامانه پایان پی، با بهره
                                    گیری از بروز ترین تکنولوژی روز دنیا در ارایه گزارشات لحظه ای گامی نو برداشته است. در
                                    ادامه، برخی از مزایای پایان پی ذکر شده است:  </p><br>
                                <ul class="list list-check animated" data-animate="fadeInUp" data-delay=".4">
                                    <li>گزارشات کلی گردش حساب</li>
                                    <li> میزان پرداخت ها در بازه های زمانی مختلف</li>
                                    <li>نمایش پراکندگی جغرافیایی پرداخت کنندگان</li>
        ...
        <section class="section section-l section-roadmap bg-white" id="roadmap">
            ...
            <div class="container">
                <!-- Section Head @s -->
                <div class="section-head text-center wide-auto">
                    <h6 class="title title-xs title-light animated" data-animate="fadeInUp" data-delay=".1">مسیر بهره
                        گیری از خدمات پایان پی</h6>
                    <h2 class="title title-lg title-dark animated" data-animate="fadeInUp" data-delay=".2">مراحل عضویت و
                        استفاده از خدمات پایان پی</h2>
                    <p class="animated" data-animate="fadeInUp" data-delay=".3">مراحل عضویت و استفاده از سیستم پایان پی
                        به شرح زیر میباشد</p>
                </div><!-- .section-head @e -->
                <!-- Block @s -->
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10">
                            <div class="roadmap-wrap">
                                ...
                                <div class="roadmap roadmap-left roadmap-finished animated" data-animate="fadeInUp"
                                     data-delay=".5">
                                    <div style="margin-top:80px" class="roadmap-step">
                                        <div class="roadmap-head">
                                            <span class="roadmap-title">عضویت در سیستم</span>
                                        </div>
                                        <p> با ورود به قسمت عضویت در سامانه و تکمیل فرم ثبت نام فرآیند عضویت شما در
                                            سیستم تکمیل شده و سپس با ورود به سیستم اطلاعات هویتی خودرا تکمیل
                                            نمایید.</p>
                                    </div>
                                </div>
                                <div class="roadmap animated " data-animate="fadeInUp" data-delay=".4">
                                ...
                                <div class="roadmap roadmap-right roadmap-finished animated" data-animate="fadeInUp"
                                     data-delay=".5">
                                    <div class="roadmap-step">
                                        ...
                                        <p> با ورود به منو تکمیل اطلاعات و احراز هویت و وارد نمودن اطلاعات در سامانه
                                            پایان پی، فرآیند احراز هویت شما آغاز شده و تیم تخصصی پایان پی به سرعت
                                            اطلاعات هویتی شمارا بررسی خواهند کرد.</p>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 mb-4 mb-lg-0 order-lg-first">
                            <div class="wgs wgs-text animated" data-animate="fadeInUp" data-delay=".1">
                                <div class="wgs-body">
                                    ...
                                    <p class="copyright-text">طراحی و توسعه در دپارتمان فناوری اطلاعات شرکت فناور ستاره
                                        نوران</p>
                                </div>
                            </div>
                        </div><!-- .col -->
