            ...
            <div class="banner banner-page"><div class="banner-wrap">
              <div class="container"><div class="row justify-content-center">
                <div class="col-xl-6 col-lg-9"><div class="banner-caption cpn tc-light text-center">
                    <div class="cpn-head"><h2 class="title ttu">جستجو محصول در فروشگاه ها</h2>
                      <form action="{{ route('products.search') }}" class="" method="post" novalidate="novalidate">
                        @csrf
                                    ...
                                    <div class="row gutter-vr-40px justify-content-center">
                                      ...
                                      @foreach($products as $product)
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                          <a target="_blank" href="{{ $product->shop->english_name . '/' . 'product'. '/' . $product->id }}" class="link link-primary link-feature-s1">
                                          <div class="feature feature-s8 feature-center card card-full card-md">
                                              <div class="feature-icon feature-icon-lg my-0"><img style="max-width: 200px;margin: 20px;height: auto;" src="{{ $product->image['original'] }}" ></div>
                                              <div class="feature-text feature-text-s8">
                                                  <h4 class="title title-sm title-thin title-s5"><span> {{ $product->title }} </span></h4>
                                                  <p>{{ str_limit($product->description, 100) }}</p><em class="link-icon icon-circle icon-circle-md ti ti-arrow-right"></em></div>
                                          </div>
                                          </a>
                                      </div>
