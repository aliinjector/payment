        ...
        <div class="page-title-box">
            <div class="float-right">
                <ol style="direction: ltr" class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">محصول فایلی</li>
                </ol>
            </div>
            <h4 class="page-title">فایل</h4>
        </div>
        <!--end page-title-box-->
    </div>
    <!--end col-->
        ...
        <form method="post" action="{{ route('product-list.update', ['id' => $product->id, 'shop' => $shop->english_name]) }}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="mt-0 header-title">فایلی</h3>
                            <div class="row">
                                ...
                                <div class="form-group mb-0 col-12">
                                    ...
                                    <div class="input-group mt-3 bg-white">
                                        ...
                                        <div class="custom-control custom-switch switch-blue mr-5 py-3">
                                            <input type="checkbox" class="custom-control-input" ireadonly @if($product->secure_payment == 'on') checked @endif>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title"> فایل</h4>
                                            </p>
                                            @php
                                            ...
                                            @if($product->attachment != null)
                                                @endif
                                                <input id="input-file-now" name="attachment" class="dropify" data-default-file="{{ $product->attachment }}">
                                        </div>
                                        <!--end card-body-->
                                    </div>
