                           ...
                           <tbody class="iranyekan">
                              ...
                              <tr role="row" class="odd icon-hover hover-color">
                                 ...
                                 <td>
                                    ...
                                    @elseif($category->parent()->get()->first() != null and $category->parent()->get()->first()->parent()->exists() and !$category->parent()->get()->first()->parent()->get()->first()->parent()->exists())
                                    {{ $category->parent()->get()->first()->parent()->get()->first()->name}}  >  {{ $category->parent()->get()->first()->name}}
                                    @elseif($category->parent()->get()->first() != null and $category->parent()->get()->first()->parent()->get()->first() != null and $category->parent()->get()->first()->parent()->get()->first()->parent()->exists() and !$category->parent()->get()->first()->parent()->get()->first()->parent()->get()->first()->parent()->exists())
                                    {{ $category->parent()->get()->first()->parent()->get()->first()->parent()->get()->first()->name}} > {{ $category->parent()->get()->first()->parent()->get()->first()->name}}  >  {{ $category->parent()->get()->first()->name}}
                                    @elseif($category->parent()->get()->first() != null and $category->parent()->get()->first()->parent()->get()->first() != null and $category->parent()->get()->first()->parent()->get()->first()->parent()->get()->first() != null and $category->parent()->get()->first()->parent()->get()->first()->parent()->get()->first()->parent()->exists() and !$category->parent()->get()->first()->parent()->get()->first()->parent()->get()->first()->parent()->get()->first()->parent()->exists())
                                    {{ $category->parent()->get()->first()->parent()->get()->first()->parent()->get()->first()->parent()->get()->first()->name}}  >  {{ $category->parent()->get()->first()->parent()->get()->first()->parent()->get()->first()->name}} > {{ $category->parent()->get()->first()->parent()->get()->first()->name}}  >  {{ $category->parent()->get()->first()->name}}
                                    @else
                                    دسته بندی اصلی
                                    @endif
                                 </td>
