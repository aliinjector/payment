...
@section('content')
    ...
    <div class="alert icon-custom-alert alert-outline-pink b-round fade show" role="alert">
        ...
        <div class="alert-text">
            حساب کاربری شما به دلیل عدم ارسال اطلاعات، غیرفعال میباشد. لطفا پس از وارد نمودن اطلاعات ذیل برروی گزینه ارسال کلیک نمایید. شایان ذکر است پس از ارسال اطلاعات، حساب کاربری شما به وضعیت در انتظار تایید قرار خواهد گرفت و پس از تایید امید شاپ، حساب فعال میگردد.
        </div>
