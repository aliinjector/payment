                    ...
                    <div class="card card-eco">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                <h3 class="font-weight-bold">۱۲۴ </h3><i class="dripicons-user-group card-eco-icon text-pink align-self-center"></i></div>
                ...
                <div class="col-lg-3">
                    <div class="card card-eco">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                <h3 class="font-weight-bold">۴۰۰۰ امتیاز </h3><i class="dripicons-jewel card-eco-icon text-warning align-self-center"></i></div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="float-right eco-revene-history justify-content-end">
                                <ul class="nav">
                                    <li class="nav-item"><a class="nav-link active" href="#">امروز</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#">دیروز</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#">هفته گذشته</a></li>
                                </ul>
                            </div>
                            <h4 class="header-title mt-0">نمودار واریزی ها و تسویه حساب های شما</h4>
                            ...
                            <div id="carousel_2" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <div class="media"><img src="/dashboard/assets/images/products/img-2.png" height="200" class="mr-4" alt="...">
                                    ...
                                    <div class="carousel-item">
                                        <div class="media"><img src="/dashboard/assets/images/products/img-3.png" height="200" class="mr-4" alt="...">
                                    ...
                                    <div class="carousel-item">
                                        <div class="media"><img src="/dashboard/assets/images/products/img-1.png" height="200" class="mr-4" alt="...">
