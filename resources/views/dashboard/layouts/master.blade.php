            ...
            <ul class="list-unstyled topbar-nav float-right mb-0">
                <li class="dropdown notification-list"><a class="nav-link dropdown-toggle arrow-none waves-light waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false"><i
                    ...
                    <div class="dropdown-menu dropdown-lg">
                        ...
                        <!-- All--><a href="javascript:void(0);" class="dropdown-item text-center text-primary">مشاهده همه <i class="fi-arrow-right"></i></a>
                    </div>
                </li>
                <li class="dropdown">
                    ...
                    <div class="dropdown-menu"><a class="dropdown-item" href="{{ route('setting.index') }}"><i class="dripicons-user text-muted mr-2"></i> تنظیمات و پروفایل کاربری</a> <a class="dropdown-item" href="{{ route('wallet.index') }}"><i
                              class="dripicons-wallet text-muted mr-2"></i> کیف پول من</a>
                        <div class="dropdown-divider"></div><a class="dropdown-item" href="{{ route('logout') }}"><i class="dripicons-exit text-muted mr-2"></i> خروج از سیستم</a>
                    </div>
                </li>
            </ul>
            <!--end topbar-nav-->
            ...
            <div class="main-icon-menu">
                <nav class="nav">
                    ...
                    <a href="#PayanPayDashboard"
                      ...
                      data-toggle="tooltip-custom" data-placement="top" title="" data-original-title="داشبورد اصلی">
                    ...
                    <a href="#PayanPayBashgah" class="nav-link" data-toggle="tooltip-custom" data-placement="top" title="" data-original-title="باشگاه مشتریان">
                        <svg class="nav-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path
                    ...
                    <a href="#PayanPayChargeShopMaker" class="nav-link" data-toggle="tooltip-custom" data-placement="top" title="" data-original-title="فروشگاه ساز شارژ">
                    ...
                    <a href="#PayanPayBill" class="nav-link" data-toggle="tooltip-custom" data-placement="top" title="" data-original-title="پرداخت قبوض">
                        <i style="color: #86a3f7;font-size: 25px" class="fas fa-ticket-alt"></i>

                    </a>


                    <a href="#PayanPayAvarez" class="nav-link" data-toggle="tooltip-custom" data-placement="top" title="" data-original-title="پرداخت عوارض و فروش بلیط">
                        <i style="color: #86a3f7;font-size: 25px" class="fas fa-money-check"></i>

                    </a>


                    <a href="#PayanPayCheck" class="nav-link" data-toggle="tooltip-custom" data-placement="top" title="" data-original-title="استعلام چک">
                        <svg class="nav-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path
                ...
                <div class="menu-body slimscroll">
                    ...
                    <div id="PayanPayShopMaker" class="main-icon-menu-pane {{ request()->is('*shop*') == 1 ? 'active' : '' }}">
                        ...
                        <ul class="nav">
                            ...
                            <li class="nav-item"><a class="nav-link" href="{{ route('slideshow.index') }}"><i class="fa fa-clone"></i>اسلایدر</a></li>
