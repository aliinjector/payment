...
<div class="page-wrapper">
    ...
    <div class="left-sidenav">
        <div class="main-icon-menu">
            <nav class="nav">
                <a href="#Dashboard" class="nav-link active" data-toggle="tooltip-custom" data-placement="top" title="" data-original-title="داشبورد اصلی">
                    <i style="color: #86a3f7;font-size: 25px" class="mdi mdi-desktop-mac-dashboard"></i>
                </a>

                <a href="#PardakhtYari" class="nav-link" data-toggle="tooltip-custom" data-placement="top" title="" data-original-title="پرداخت یاری">
    ...
    <div class="page-content">
        ...
        <!-- container -->
        <footer class="footer text-center text-sm-left">&copy; ۱۳۹۸ - کلیه حقوق محفوظ است. <span class="text-muted d-none d-sm-inline-block float-right">طراحی و توسعه در دپارتمان فناوری اطلاعات شرکت پین پی</span></footer>
        <!--end footer-->
    </div>
    <!-- end page content -->
</div>
